...
<Hero3Images/>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 md:gap-16">    
            ...
            >
              <p className="text-lg leading-relaxed mb-6">
                Brend <strong>Klupko Klupče</strong> je nastao sredinom 2025. godine iz čiste ljubavi prema pletenju. 
                Sve je počelo kao hobi, a danas se razvio u posvećenost kreiranju kvalitetnih handmade proizvoda od vune.
              </p>
              
              <p className="text-lg leading-relaxed mb-6">
                Trenutno se nalazimo u fazi inkubacije poslovanja i ispitivanja tržišta za potrebom proizvoda od vune. 
                Naša misija je da pružimo jedinstvene, ručno rađene proizvode koji kombinuju tradicionalne tehnike pletenja 
                sa modernim dizajnom i funkcionalnošću.
              </p>
              
              <p className="text-lg leading-relaxed mb-8">
                Svaki proizvod se plete isključivo ručno od vunice <strong>Alize Pyffi</strong> i <strong>Alize Pyffi Fine</strong>, 
                koja je antialergijska i sigurna za sve generacije - od beba do najstarijih. Ova vunica je poznata po svojoj 
      ...
      {/* Proizvodi sekcija */}
      <section className="py-20 bg-gradient-to-br from-gray-200 via-white to-gray-200" id="kategorije">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">Naši Proizvodi</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Specijalizovani smo za kreiranje različitih vrsta handmade proizvoda od vune, 
              svaki pažljivo dizajniran i ručno pleten sa pažnjom prema detaljima.
            </p>
          </motion.div>
            ...
            {categories.map((category: { _id: string; title: string; slug: { current: string }; description: string; image?: { asset: { _ref: string } } }, index: number) => (
              ...
              >
                <Link href={`/proizvodi/${category.slug.current}`}>
                  ...
                  <div className="p-5">
                    <h3 className="text-2xl font-semibold mb-2 text-primary">{category.title}</h3>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary">Zašto Klupko Klupče?</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Naša prednost leži u kombinaciji tradicionalnih tehnika, kvalitetnih materijala i personalizovanog pristupa.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Svaki proizvod je ručno pleten sa pažnjom prema detaljima i kvalitetu."
              },
              {
                icon: <Award className="w-8 h-8" />,
                title: "Kvalitetni Materijali",
                description: "Koristimo samo antialergijsku vunicu Alize Pyffi i Alize Pyffi Fine."
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Personalizovani Pristup",
                description: "Mogućnost izbora boje, mustre, namene i pakovanja u dogovoru sa nama."
              },
              {
                icon: <Star className="w-8 h-8" />,
                title: "Jedinstveni Dizajn",
                description: "Svaki proizvod je jedinstven i kreiran sa ljubavlju prema zanatu."
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
